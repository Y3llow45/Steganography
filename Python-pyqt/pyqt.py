...
from PySide6.QtWidgets import QApplication, QMainWindow, QLabel, QPushButton, QFileDialog, QRadioButton
...
class SteganographyApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.select_second_button = QPushButton("Select second image", self)
